...
const pageMetadata = {
  home: {
    title:
      "EnnéaMaroc – Coaching Ennéagramme & développement personnel à Tanger",
    description:
  ...
  contact: {
    title: "EnnéaMaroc – Contact Coaching Maroc et accompagnement individuel",
    description:
  ...
  approfondir: {
    title: "EnnéaMaroc – Approfondir l'Ennéagramme – Formation & croissance personnelle",
    description:
  ...
  transmettre: {
    title: "EnnéaMaroc – Transmettre l'Ennéagramme – Coaching professionnel & leadership conscient",
    description:
  ...
  ecole: {
    title: "EnnéaMaroc – École Ennéagramme Maroc – Formation professionnelle et accompagnement",
    description:
  ...
  solution: {
    title: "EnnéaMaroc – Solutions coaching Maroc – Leadership conscient et management humain",
    description:
  ...
  agenda: {
    title: "EnnéaMaroc – Agenda Ennéagramme Tanger – Ateliers, retraites et constellations familiales",
    description:

...
const HeroBanner1 = ({
  ...
  // Accept legacy prop `btnurl` while prioritizing explicit `inscriptionUrl`
  btnurl,
  ...
  return (
    ...
    >
      <style>{`
        ...
        .hb-container{ width:100%; max-width:1100px; padding: clamp(80px, 8vw, 120px) 20px; }
